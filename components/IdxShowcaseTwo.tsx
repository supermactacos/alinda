...
export function IdxShowcaseTwo() {
  ...
  useEffect(() => {
    ...
    script.id = "idxwidgetsrc-26931";
    script.src = "//mlspalmbeach.lindaolsson.com/idx/customshowcasejs.php?widgetid=26931";
    ...
    style.textContent = `
      ...
      /* Table structure */
      #IDX-showcaseGallery-26931 .IDX-showcaseTable {
        width: 100% !important;
      ...
      #IDX-showcaseGallery-26931 .IDX-showcaseRow {
        display: table-row !important;
      }

      #IDX-showcaseGallery-26931 .IDX-showcaseCell {
      ...
      #IDX-showcaseGallery-26931 .IDX-showcaseContainer {
      ...
      /* Content spacing */
      #IDX-showcaseGallery-26931 .IDX-showcaseContent {
        padding: 0 !important;
        margin: 0 !important;
        height: auto !important;
        min-height: 0 !important;
      ...
      #IDX-showcaseGallery-26931 .IDX-showcaseAddress {
        margin: 0 !important;
      ...
      #IDX-showcaseGallery-26931 .IDX-showcasePrice {
      ...
      #IDX-showcaseGallery-26931 .IDX-showcaseCityStateZip {
        margin: 0 !important;
        padding: 0 !important;
        line-height: 1.2 !important;
        height: auto !important;
      ...
      #IDX-showcaseGallery-26931 .IDX-showcasePhoto {
        width: 100% !important;
        height: auto !important;
      ...
      #IDX-showcaseGallery-26931 .IDX-showcaseLink {
        width: 100% !important;
        height: auto !important;
        display: block !important;
      ...
      #IDX-showcaseGallery-26931 .IDX-showcaseListingID,
      #IDX-showcaseGallery-26931 .IDX-showcaseBeds,
      #IDX-showcaseGallery-26931 .IDX-showcaseBaths,
      #IDX-showcaseGallery-26931 .IDX-showcaseFull,
      #IDX-showcaseGallery-26931 .IDX-showcasePartial,
      #IDX-showcaseGallery-26931 .IDX-showcaseRemarks,
      #IDX-showcaseGallery-26931 .IDX-showcaseDisclaimerLink,
      #IDX-showcaseGallery-26931 .IDX-showcaseStatus,
      #IDX-showcaseGallery-26931 .IDX-showcaseStateAbrv {
    ...
    return () => {
      observer.disconnect();
      const existingScript = document.getElementById("idxwidgetsrc-26931");
      if (existingScript) {
