...
interface IdxShowcaseThreeProps {
  widgetId: string;
}

export function IdxShowcaseThree({ widgetId }: IdxShowcaseThreeProps) {
  ...
  useEffect(() => {
    ...
    script.src = `//mlspalmbeach.lindaolsson.com/idx/customshowcasejs.php?widgetid=${widgetId}`;
    ...
    style.textContent = `
      ...
      /* Table structure */
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseTable {
        width: 100% !important;
      ...
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseRow {
        display: table-row !important;
      }

      #IDX-showcaseGallery-${widgetId} .IDX-showcaseCell {
      ...
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseContainer {
      ...
      /* Content spacing */
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseContent {
        padding: 0 !important;
        margin: 0 !important;
        height: auto !important;
        min-height: 0 !important;
      ...
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseAddress {
        margin: 0 !important;
      ...
      #IDX-showcaseGallery-${widgetId} .IDX-showcasePrice {
      ...
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseCityStateZip {
        margin: 0 !important;
        padding: 0 !important;
        line-height: 1.2 !important;
        height: auto !important;
      ...
      #IDX-showcaseGallery-${widgetId} .IDX-showcasePhoto {
        width: 100% !important;
        height: auto !important;
      ...
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseLink {
        width: 100% !important;
        height: auto !important;
        display: block !important;
      ...
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseListingID,
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseBeds,
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseBaths,
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseFull,
      #IDX-showcaseGallery-${widgetId} .IDX-showcasePartial,
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseRemarks,
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseDisclaimerLink,
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseStatus,
      #IDX-showcaseGallery-${widgetId} .IDX-showcaseStateAbrv {
