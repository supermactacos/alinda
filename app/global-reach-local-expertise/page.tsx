...
export default function GlobalReachPage() {
  ...
  useEffect(() => {
    ...
    // Set iframe loaded to true after component mounts on client
      ...
      <main className="relative min-h-screen w-full overflow-x-hidden pt-[120px]">
        <section className="pt-32 bg-white relative" style={{ zIndex: 30 }}>
          <div className="container mx-auto px-4">
            ...
            {/* YouTube Video - only rendered on client side to prevent hydration mismatch */}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-start gap-6 mb-6">
                <p className="text-gray-800 text-xl leading-relaxed flex-1">
                  Our unrivaled website ranks high on Google searches we continually update our web site with the most current information to keep our customers abreast of the market in Palm Beach and the surrounding area. Our web site is powered by the most current technology to advance our site in Google searches... their success in continuing to connect with qualified buyers and sellers worldwide is remarkable! We feature your luxury property on the internet's most highly visible websites, for example: REALTOR.COM, ZILLOW.COM, TRULIA.COM
                </p>
                <img
                  src="/grlinda2.jpg"
