              ...
              <div className="max-w-4xl mx-auto mb-16">
                ...
                <div className="mt-20">
                  ...
                  <div className="building-listing mt-16">
                    ...
                    <div className="prose prose-lg max-w-none">
                      <p>
                        Situated directly on the Intracoastal just south of Okeechobee, this 111 unit condominium building of two bedroom two bath split floor plan units on 19 floors was built in 1972. The structure is curved, which provides each unit with magnificent east and south views of the Intracoastal, yachts, ocean, and Town of Palm Beach. The Trianon has a direct Intracoastal pool and is a long time favorite of Palm Beachers. Full service building with manager, doorman, covered and open parking. Building does not allow pets. Allows rentals with restrictions–1 x/year after owning 1 year. Application and interview required.
                      </p>
                    </div>
                  </div>
